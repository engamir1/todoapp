  ...
  Widget build(BuildContext context) {
    ...
    return BlocConsumer<NewsCubit, NewsState>(
      ...
      builder: (context, state) {
        return cubit.sportsList.isNotEmpty
            ? ListView.builder(
                itemBuilder: (context, index) {
                  return ArticleWidget(
                    articleImage: cubit.sportsList[index]["urlToImage"] ??
                    ...
                    atricleTitle: cubit.sportsList[index]["title"],
                    publishedAt: cubit.sportsList[index]["publishedAt"],
                  );
                },
