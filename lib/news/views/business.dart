  ...
  Widget build(BuildContext context) {
    ...
    return BlocConsumer<NewsCubit, NewsState>(
      ...
      builder: (context, state) {
        return cubit.businessList.isNotEmpty
            ? ListView.builder(
                itemBuilder: (context, index) {
                  return ArticleWidget(
                    articleImage: cubit.businessList[index]["urlToImage"] ??
                    ...
                    atricleTitle: cubit.businessList[index]["title"],
                    publishedAt: cubit.businessList[index]["publishedAt"],
                  );
                },
